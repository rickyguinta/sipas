      ...
      <!-- AKHIR FLASH DATA -->
          <div class="title-bar">
            <h1 class="title-bar-title">
              <span class="d-ib">TEMBUSAN MASUK</span>
            </h1>
          </div>
          <hr>
            ...
            <div class="col-xs-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <strong>Daftar Tembusan Masuk</strong>
                </div>
                <div class="card-body">
                <table id="demo-datatables-colreorder-2" class="table table-hover table-striped table-bordered dataTable" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td class="text-center"><a class="badge badge-primary" href="<?php if($d['jenis_surat'] == 1 ){ ?> <?= base_url(); ?>tembusan_masuk/in_detail_tembusan/<?= $d['id_tembusan_kirim']; ?> <?php } ?>"><span class="icon icon-eye"></span> Detail</a></td>
                    </tr>
                    <?php } ?>
                    </tbody>
                  </table>

    ...
    <script src="<?php echo base_url() ?>assets/admin/core/bootstrap.min.js"></script>
    <script src="<?php echo base_url() ?>assets/admin/plugins/perfect-scrollbar.min.js"></script>
    <script src="<?php echo base_url() ?>assets/admin/plugins/smooth-scrollbar.min.js"></script>
    <script src="<?php echo base_url() ?>assets/admin/plugins/chartjs.min.js"></script>
    <script>
    ...
    <script src="<?php echo base_url() ?>assets/admin/js/argon-dashboard.min.js"></script>
    </script>

      ...
      <!-- AKHIR FLASH DATA -->
          <div class="title-bar">
            <h1 class="title-bar-title">
              <span class="d-ib">DETAIL NOTA DINAS</span>
            </h1>
          </div>
          <hr>
        <!-- ISI -->
        <div class="row gutter-xs">
          ...
          <strong>NOTA DINAS | <a href="<?= base_url(); ?>nota_dinas_masuk/cetak_notdis/<?= $data['id_surat_notdis']; ?>" target="_blank">Cetak</a></strong><?php if($data['id_pengirim_awal'] == $this->session->userdata('id')){ ?> <strong><a href="<?= base_url(); ?>nota_dinas_masuk/edit_notdis/<?= $data['id_surat_notdis']; ?>" style="float:right;">Edit</a></strong> <?php } ?>
                </div>
                <div class="card-body">
                <!--  -->
                <!-- tabel -->
                <center>
                        <img src="<?= base_url(); ?>assets/images_barcode/<?= $data['qr_code']; ?>" alt="" width="100">       
                </center>
            <br>
                <table class="table table-hover table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td class="text-left" height="100">Rujukan</td>
                        <td>:</td>
                        <td align="justify"><div style="margin-left:-20px;"> <?= $data['rujukan_notdis']; ?></div></td>
                      </tr>
                      <tr>
                        <td class="text-left">Isi Surat</td>
                        <td>:</td>
                        <td align="justify">
                        <?php 
                  ...
                  <br>
                        <center>
                        <a href="<?= base_url(); ?>disposisi/index/<?= $data['id_surat_notdis']; ?>" class="btn btn-primary">Disposisi</a>
                        </center>
                 <?php } }?>
                    ...
                    <table class="table table-striped table-bordered">
                      ...
                      <?php $no=1; foreach($persetujuan_notdis as $l){ ?>
                        <tr>
                          ...
                          <?php if($l['is_read'] == 1){ ?>
                          <a href="<?= base_url(); ?>nota_dinas_masuk/cetak_persetujuan/<?= $l['id_persetujuan_notdis']; ?>" target="_blank">download</a> 
                          <?php } ?>
                          </td>
                        </tr>
                      <?php } ?>

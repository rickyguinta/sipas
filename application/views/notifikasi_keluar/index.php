      ...
      <!-- AKHIR FLASH DATA -->
          <div class="title-bar">
            <h1 class="title-bar-title">
              <span class="d-ib">NOTIFIKASI KELUAR</span>
            </h1>
          </div>
          <hr>
            ...
            <div class="col-xs-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <strong>Notifikasi Keluar</strong>
                </div>
                <div class="card-body">
  ...
  <?php $no=0; foreach($data as $x): $no++; ?>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <?php echo form_open('notifikasi_keluar/hapus_data') ?>
  ...
  <?php endforeach;?>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
        <?php echo form_open('Notifikasi_keluar/edit_data') ?>
        <input type="hidden" value="<?= $x['id_notifikasi']; ?>" name="id" class="form-control" >

      ...
      <!-- AKHIR FLASH DATA -->
          <div class="title-bar">
            <h1 class="title-bar-title text-white">
              <span class="d-ib">HISTORY NOTA DINAS</span>
            </h1>
          </div>
          <hr>
            ...
            <div class="col-xs-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <strong>Daftar History Nota Dinas</strong>
                </div>
                <div class="card-body">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header bg-primary">
          <h4 class="modal-title">Hapus Data Nota Dinas</h4>
        </div>
        <div class="modal-body">
        <?php echo form_open('history/hapus_notdis') ?>

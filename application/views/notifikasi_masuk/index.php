<div class="layout-content">
      ...
      <!-- AKHIR FLASH DATA -->
          <div class="title-bar">
            <h1 class="title-bar-title">
              <span class="d-ib">NOTIFIKASI MASUK</span>
            </h1>
          </div>
          <hr>
            ...
            <div class="col-xs-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <strong>Notifikasi Masuk</strong>
                </div>
                <div class="card-body">
                <table id="demo-datatables-colreorder-2" class="table table-hover table-striped table-bordered dataTable" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <a class="badge badge-success" href="#modal-tl<?= $d['id_notifikasi']; ?>" data-toggle="modal"><span class="icon icon-mail-reply"></span> Reply</a> ||
  ...
  <?php $no=0; foreach($data as $x): $no++; ?>
    <div id="modal-tl<?= $x['id_notifikasi'] ?>" tabindex="-1" role="dialog" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header bg-primary">
          <h4 class="modal-title">Jawab Notifikasi</h4>
        </div>
        <div class="modal-body">
        <?php echo form_open('Notifikasi_masuk/tindak_lanjut') ?>

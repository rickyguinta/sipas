...
class Auth extends CI_Controller {
            ...
            if($user){
                    if(password_verify($password, $user['password'])){
                        $data= [
                            ...
                            'level' => $user['level'],
                            'is_tingkatan' => $user['is_tingkatan'],
                        ...
                        $this->session->set_flashdata('message','<div id="notifikasi" class="alert alert-warning" role="alert">Login failed! Wrong password.</div>');
                        redirect('auth');
                    }
            }
            else{
                $this->session->set_flashdata('message','<div id="notifikasi" class="alert alert-warning" role="alert">Account is not registered</div>');
                redirect('auth');
            }
    }
    ...
    private function _sendEmail($token,$type){
        // kalau di upload ke hosting ubah ke ssmtp
    ...
    public function logout(){
        ...
        $this->session->unset_userdata('is_tingkatan');
